...
| 🛡️ [**09_Network Protocol Forensics and Threat Hunting**](https://github.com/CyberSal/Cybersecurity-Portfolio/tree/main/09_Network Protocol Forensics and Threat Hunting) | Snort rule implementation, Linux `iptables` defense, and protocol analysis. | Perimeter Defense |
